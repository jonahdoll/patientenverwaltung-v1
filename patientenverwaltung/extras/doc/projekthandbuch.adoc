...
== Der Microservice Patientenverwaltung
...
."PatientController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,PatientController,svg]
----
include::./PatientController.plantuml[]
----

."PatientWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,PatientWriteController,svg]
----
...
.Die Service-Klasse "PatientService" für die Geschäftslogik
[plantuml,PatientService,svg]
----
include::./PatientService.plantuml[]
----

bla bla

.Die Service-Klasse "PatientWriteService" für die Geschäftslogik
...
.Die Entity-Klasse "Patient" für Patientendaten
